...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Web", "Dev", "Term", "Msg", "Tel", "Mus", "Vid", "Sys", "GFX" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Rofi
    awful.key({ superkey }, "0", function() awful.spawn.with_shell("flameshot gui") end,
              {description="screenshots", group="screen"}
              ),
    awful.key({ superkey }, "r", function() awful.spawn.with_shell("polybar-msg cmd show ; rofi -show drun") end,
...
awful.spawn.with_shell("feh --bg-fill /home/e/wallpapers")
awful.spawn.with_shell("polybar -c ~/.config/polybar/config.ini main")
